...
| Stage | Metric | Value |
|--------|-------|----------------|
| **Stage 1: Fault Detection** | F1-Score | $0.87$ |
| **Stage 2: RCA (Localization)** | Top-1 Accuracy | $62.5 \pm 8.0\%$ |
| **Stage 2: RCA (Localization)** | Top-3 Accuracy | $75.0 \pm 6.0\%$ |
| **Stage 2: RCA (Localization)** | Top-5 Accuracy | $98.0 \pm 1.0\%$ |
...
- **Maximum Learning Rate**: $4 \times 10^{-4}$
- **Optimizer**: AdamW
- **Weight Decay**: $1 \times 10^{-4}$
- **Label Smoothing**: $0.01$
- **Loss Function**: BCEWithLogitsLoss with class weights
- **Class Imbalance Handling**: Positive Class Weighting + Weighted Random Sampler
...
This project is designed to run on **Colab Notebooks** with GPU acceleration.

#### Prerequisites
- Google Colab account (free)
- Enable GPU accelerator in Colab setting by changing runtime type
- Python 3.x
